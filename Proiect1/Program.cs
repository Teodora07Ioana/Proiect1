...
options.UseSqlServer(builder.Configuration.GetConnectionString("Proiect1Context")?? throw new InvalidOperationException("Connectionstring 'Proiect1Context' not found.")));
